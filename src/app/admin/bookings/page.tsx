...
export default async function OwnerBookingsPage() {
  ...
  return <div className="min-h-screen text-stone-950"><SiteHeader /><main className="page-shell py-8 sm:py-12"><OwnerNav current="bookings" /><h1 className="page-title mt-8">Bookings</h1>{data.operations.status === "success" ? <OwnerOperationsPanel dashboard={data.operations.dashboard} /> : <BookingsLoadError />}</main></div>;
}
