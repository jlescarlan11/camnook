-- Reject precision the two-decimal ledger cannot represent exactly.
-- Match existing Server Action validation without silently rounding a decision.
...
begin
  if p_booking_id is null
    ...
    or p_deduction_amount <> round(p_deduction_amount, 2)
